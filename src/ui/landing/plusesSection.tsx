...
import { LandingCard } from '../utils/card'
import { SectionHeader } from '../utils/header'
...
export function PlusesSection({ userType, gradient = false, animations = [] }: PlusesSectionProps) {
  ...
  return <Section animations={animations} color={gradient ? (userType === 'teacher' ? 'tertiary' : 'secondary') : undefined}>
    <SectionHeader 
      onGradient={gradient} 
      maxWidth={700} 
